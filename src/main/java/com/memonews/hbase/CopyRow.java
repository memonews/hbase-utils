...
public class CopyRow {
	...
	public static void main(final String[] args) throws Exception {
		...
		if (remainingArgs.length != 4) {
			...
			HBaseUtil.copyRow(conf, remainingArgs[0], remainingArgs[1], remainingArgs[2], remainingArgs[3]);
		}
	}

	private static String getUsage() {
		return "hadoop jar target/hbase-utils-1.0-SNAPSHOT.jar com.memonews.hbase.CopyRow [-conf ...] <source-table> <source-row> <target-table> <target-row>";
	}
}
