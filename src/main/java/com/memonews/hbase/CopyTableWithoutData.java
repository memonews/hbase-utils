 ...
 */
public class CopyTableWithoutData {
	...
	if (remainingArgs.length != 2) {
	    ...
	    HBaseAdminUtil.copyTableWithoutData(conf, remainingArgs[0], remainingArgs[1]);
	}

    }

    private static String getUsage() {
	return "hadoop jar target/hbase-utils-1.0-SNAPSHOT.jar com.memonews.hbase.CopyTableWithoutData [-conf ...] <source> <target>";
    }
}
